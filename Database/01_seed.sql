-- Reference seed data for the `states` table.
--
-- This file is intended to be safe to run more than once. PostgreSQL's
-- Docker entrypoint only runs init SQL on a brand-new data directory, but
-- making seed scripts idempotent keeps local rebuilds and manual reruns simple.
BEGIN;
...
-- Tables that still need to be seeded:
-- sources
-- counties
-- postal_codes
-- neighborhoods
